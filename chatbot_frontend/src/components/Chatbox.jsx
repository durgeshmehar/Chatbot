  ...
  const handleSubmit = (e) => {
    ...
    if (!userData) {
      ...
      const sendData = async () => {
        ...
        if (response && response.data) {
          const sendReceiveData = { ...response.data, user_message: userEntermsg };
        ...
        <div className="w-full flex justify-center items-center gap-8 px-8">
          ...
          >
            <input
              ...
              value={inputmsg.msg}
              onChange={(e) => setInputmsg({ show: false, msg: e.target.value })}
            ...
            <button
              type="submit"
              className={`relative right-[3rem] h-8 flex justify-center items-center px-2 m-2 mr-3 rounded-lg text-base cursor-pointer border-none ${inputmsg.msg.length > 0
